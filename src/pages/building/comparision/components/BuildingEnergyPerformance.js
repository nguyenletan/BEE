...
const BuildingEnergyPerformance = ({ improved }) => {
  ...
  const Indicator = ({ text, backgroundColor, type }) =>
    improved === text && (
      <>
        <BarBlock width="53px" backgroundColor={backgroundColor} text={text} isArrow textAlign="center" marginLeft="7px" />
      ...
      <BarWrapper className="d-flex" marginRight="30px">
        <BarChart>
          ...
          <div className="d-flex ">
            ...
            <BarBlock width="53px" backgroundColor="#F0EA6F" text="D" isArrow textAlign="center" marginLeft="7px" />
