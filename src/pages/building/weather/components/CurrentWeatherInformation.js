        ...
        {weatherInfo && weatherInfo?.days && (
          <Wrapper>
            <div className="pb-3">
              ...
              <Information>
                <span>
                  <label>Average:</label> {weatherInfo?.days[0].temp} ℃
                </span>
                <span>
                  <label>Min:</label> {weatherInfo?.days[0].tempmin} ℃
                </span>
                <span>
                  <label>Max:</label> {weatherInfo?.days[0].tempmax} ℃
                </span>
                <span>
                  <label>Dew Point:</label> {weatherInfo?.days[0].dew} ℃
                </span>
              </Information>
            </div>
            <div>
              ...
              <Information>
                ...
                <span>
                  <label>Pressure:</label> {weatherInfo?.days[0].pressure} Pa
                </span>
                <span>
                  <label>Wind Speed:</label> {weatherInfo?.days[0].windspeed} ℃
                </span>
                <span>
                  <label>Wind Degree:</label> {weatherInfo?.days[0].winddir}
                </span>
              </Information>
            </div>
          </Wrapper>
